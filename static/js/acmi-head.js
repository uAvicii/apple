!function(e) {
    ...
    ({
            ...
            new MutationObserver(((t, n) => {
                for (const o of t) {
                    if ("data-segment-code" === o.attributeName)
                        return e = document.documentElement.dataset.segmentCode, n.disconnect(), this.hideACMI(e), void this.watchExit()
                }
            })).observe(t, {
                attributes: !0
            })
        ...
        hideACMI(e) {
            "smb" === e || document.documentElement.classList.add("hide-acmi")
        },
        watchExit() {
            ...
            new MutationObserver(((t, n) => {
                for (const o of t)
                    if (e = o.target.querySelector(".ac-gn-segmentbar-exit, .globalmessage-segment-exit"), e)
                        return n.disconnect(), void this.handleExitClicked(e)
            })).observe(t, {
                childList: !0
            })
        },

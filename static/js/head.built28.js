...
};c.exports=f},{"./data":4,"@marcom/ac-polyfills/Array/prototype.filter":36,"@marcom/ac-polyfills/Array/prototype.some":44}],3:[function(b,c,a){c.exports={getDocumentMode:function(){var d;
...
},{}],5:[function(b,c,a){c.exports={getWindow:function(){return window},getDocument:function(){return document
},getNavigator:function(){return navigator}}},{}],6:[function(c,d,b){var g=c("./helpers/globals");
...
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":5,"@marcom/ac-function/once":8}],7:[function(c,d,b){var g=c("./helpers/globals");
var f=c("@marcom/ac-function/once");function a(){var j=g.getWindow();var h=g.getDocument();
var i=g.getNavigator();return !!(("ontouchstart" in j)||(j.DocumentTouch&&h instanceof j.DocumentTouch)||(i.maxTouchPoints>0)||(i.msMaxTouchPoints>0))
}d.exports=f(a);d.exports.original=a},{"./helpers/globals":5,"@marcom/ac-function/once":8}],8:[function(b,c,a){c.exports=function d(g){var f;
return function(){if(typeof f==="undefined"){f=g.apply(this,arguments)}return f
}}},{}],9:[function(g,a,s){var j=a.exports={};var k;var m;function h(){throw new Error("setTimeout has not been defined")
...
};j.umask=function(){return 0}},{}],10:[function(b,c,a){b("@marcom/ac-polyfills/Array/prototype.slice");
...
}for(g=0;g<j.length;g++){d(h,j[g])}}},{"./className/add":11,"@marcom/ac-polyfills/Array/prototype.slice":43,"@marcom/ac-polyfills/Element/prototype.classList":51}],11:[function(b,c,a){var d=b("./contains");
...
return}for(g=0;g<j.length;g++){b(h,j[g])}}},{"./className/remove":14,"@marcom/ac-polyfills/Array/prototype.slice":43,"@marcom/ac-polyfills/Element/prototype.classList":51}],16:[function(c,d,b){c("@marcom/ac-polyfills/Array/prototype.forEach");
...
})}},{"./FeatureDetect":17,"./FocusManager":18,"./defaultTests":20,"@marcom/ac-polyfills":66}],20:[function(f,g,d){var h=f("@marcom/ac-browser");
...
},{"@marcom/ac-browser":1,"@marcom/ac-feature/svgAvailable":6,"@marcom/ac-feature/touchAvailable":7}],21:[function(b,c,a){(function(h){if(!h.console){h.console={}
...
},{_process:9}],25:[function(d,f,a){var c={instrument:false};function b(g,h){if(arguments.length===2){c[g]=h
...
b("./Element/prototype.matches");b("./Element/prototype.remove")},{"./Element/prototype.classList":51,"./Element/prototype.matches":52,"./Element/prototype.remove":53}],51:[function(b,c,a){
/*! @source http://purl.eligrey.com/github/classList.js/blob/master/classList.js*/
if("document" in self){if(!("classList" in document.createElement("_"))){(function(n){if(!("Element" in n)){return
}var d="classList",j="prototype",q=n.Element[j],f=Object,o=String[j].trim||function(){return this.replace(/^\s+|\s+$/g,"")
},g=Array[j].indexOf||function(u){var t=0,s=this.length;for(;t<s;t++){if(t in this&&this[t]===u){return t
...
while(--d>=0&&g.item(d)!==this){}return d>-1}}},{}],53:[function(b,c,a){c.exports=(function(){if(!("remove" in Element.prototype)){Element.prototype.remove=function(){if(this.parentNode){this.parentNode.removeChild(this)
}}}})},{}],54:[function(b,c,a){b("./Function/prototype.bind")},{"./Function/prototype.bind":55}],55:[function(b,c,a){if(!Function.prototype.bind){Function.prototype.bind=function(d){if(typeof this!=="function"){throw new TypeError("Function.prototype.bind - what is trying to be bound is not callable")
}var i=Array.prototype.slice.call(arguments,1);var h=this;var f=function(){};var g=function(){return h.apply((this instanceof f&&d)?this:d,i.concat(Array.prototype.slice.call(arguments)))
};f.prototype=this.prototype;g.prototype=new f();return g}}},{}],56:[function(require,module,exports){if(typeof JSON!=="object"){JSON={}
}(function(){function f(n){return n<10?"0"+n:n}if(typeof Date.prototype.toJSON!=="function"){Date.prototype.toJSON=function(){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+f(this.getUTCMonth()+1)+"-"+f(this.getUTCDate())+"T"+f(this.getUTCHours())+":"+f(this.getUTCMinutes())+":"+f(this.getUTCSeconds())+"Z":null
};String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(){return this.valueOf()
}}var cx,escapable,gap,indent,meta,rep;function quote(string){escapable.lastIndex=0;
return escapable.test(string)?'"'+string.replace(escapable,function(a){var c=meta[a];
...
return typeof reviver==="function"?walk({"":j},""):j}throw new SyntaxError("JSON.parse")
}}}())},{}],57:[function(b,c,a){b("./Object/assign");b("./Object/create");b("./Object/is");
b("./Object/keys")},{"./Object/assign":58,"./Object/create":59,"./Object/is":60,"./Object/keys":61}],58:[function(c,d,b){var g=navigator.userAgent.toLowerCase();
...
k<arguments.length;k++){for(var j in arguments[k]){if(arguments[k].hasOwnProperty(j)){arguments[0][j]=arguments[k][j]
}}}return arguments[0]}}}},{}],59:[function(b,c,a){if(!Object.create){var d=function(){};
Object.create=function(f){if(arguments.length>1){throw new Error("Second argument not supported")
}if(f===null||typeof f!=="object"){throw new TypeError("Object prototype may only be an Object.")
}d.prototype=f;return new d()}}},{}],60:[function(b,c,a){if(!Object.is){Object.is=function(f,d){if(f===0&&d===0){return 1/f===1/d
}if(f!==f){return d!==d}return f===d}}},{}],61:[function(b,c,a){if(!Object.keys){Object.keys=function d(g){var f=[];
var h;if((!g)||(typeof g.hasOwnProperty!=="function")){throw"Object.keys called on non-object."
}for(h in g){if(g.hasOwnProperty(h)){f.push(h)}}return f}}},{}],62:[function(b,c,a){c.exports=b("es6-promise").polyfill()
},{"es6-promise":22}],63:[function(b,c,a){b("./String/prototype.trim")},{"./String/prototype.trim":64}],64:[function(c,d,b){if(!String.prototype.trim){String.prototype.trim=function a(){return this.replace(/^\s+|\s+$/g,"")
}}},{}],65:[function(b,c,a){window.XMLHttpRequest=window.XMLHttpRequest||function(){var f;
try{f=new ActiveXObject("Msxml2.XMLHTTP")}catch(d){try{f=new ActiveXObject("Microsoft.XMLHTTP")
}catch(d){f=false}}return f}},{}],66:[function(b,c,a){b("./Array");b("./console.log");
...
b("./String");b("./XMLHttpRequest")},{"./Array":33,"./CustomEvent":45,"./Date":46,"./Element":50,"./Function":54,"./JSON":56,"./Object":57,"./Promise":62,"./String":63,"./XMLHttpRequest":65,"./console.log":67,"./getComputedStyle":68,"./html5shiv":69,"./matchMedia":70,"./requestAnimationFrame":71}],67:[function(b,c,a){b("console-polyfill")
},{"console-polyfill":21}],68:[function(d,f,c){if(!window.getComputedStyle){function g(j,m,l){j.document;
var k=j.currentStyle[m].match(/(-?[\d\.]+)(%|cm|em|in|mm|pc|pt|)/)||[0,0,""],i=k[1],n=k[2],h;
l=!l?l:/%|em/.test(n)&&j.parentElement?g(j.parentElement,"fontSize",null):16;h=m=="fontSize"?l:/width/i.test(m)?j.clientWidth:j.clientHeight;
return n=="%"?i/100*h:n=="cm"?i*0.3937*96:n=="em"?i*l:n=="in"?i*96:n=="mm"?i*0.3937*96/10:n=="pc"?i*12*96/72:n=="pt"?i*96/72:i
}function b(k,n){var o=n=="border"?"Width":"",j=n+"Top"+o,m=n+"Right"+o,h=n+"Bottom"+o,i=n+"Left"+o;
...
}};window.getComputedStyle=function(h){return new a(h)}}},{}],69:[function(b,c,a){b("html5shiv/src/html5shiv")
},{"html5shiv/src/html5shiv":32}],70:[function(b,c,a){window.matchMedia=window.matchMedia||(function(i,j){var g,d=i.documentElement,f=d.firstElementChild||d.firstChild,h=i.createElement("body"),k=i.createElement("div");
k.id="mq-test-1";k.style.cssText="position:absolute;top:-100em";h.style.background="none";
h.appendChild(k);return function(l){k.innerHTML='&shy;<style media="'+l+'"> #mq-test-1 { width:42px; }</style>';
d.insertBefore(h,f);g=k.offsetWidth===42;d.removeChild(h);return{matches:g,media:l}
}}(document))},{}],71:[function(b,c,a){(function(){var f=0;var g=["ms","moz","webkit","o"];
for(var d=0;d<g.length&&!window.requestAnimationFrame;++d){window.requestAnimationFrame=window[g[d]+"RequestAnimationFrame"];
window.cancelAnimationFrame=window[g[d]+"CancelAnimationFrame"]||window[g[d]+"CancelRequestAnimationFrame"]
}if(!window.requestAnimationFrame){window.requestAnimationFrame=function(l,i){var h=Date.now();
var j=Math.max(0,16-(h-f));var k=window.setTimeout(function(){l(h+j)},j);f=h+j;
return k}}if(!window.cancelAnimationFrame){window.cancelAnimationFrame=function(h){clearTimeout(h)
}}}())},{}],72:[function(b,c,a){var d={ua:window.navigator.userAgent,platform:window.navigator.platform,vendor:window.navigator.vendor};
c.exports=b("./parseUserAgent")(d)},{"./parseUserAgent":75}],73:[function(b,c,a){c.exports={browser:{safari:false,chrome:false,firefox:false,ie:false,opera:false,android:false,edge:false,version:{name:"",major:0,minor:0,patch:0,documentMode:false}},os:{osx:false,ios:false,android:false,windows:false,linux:false,fireos:false,chromeos:false,version:{name:"",major:0,minor:0,patch:0}}}
},{}],74:[function(b,c,a){c.exports={browser:[{name:"edge",userAgent:"Edge",version:["rv","Edge"],test:function(d){return(d.ua.indexOf("Edge")>-1||d.ua==="Mozilla/5.0 (Windows NT 10.0; Win64; x64)")
...
},{}],75:[function(b,a,d){var c=b("./defaults");var h=b("./dictionary");function g(k){return new RegExp(k+"[a-zA-Z\\s/:]+([0-9_.]+)","i")
...
return k}a.exports=i},{"./defaults":73,"./dictionary":74}],76:[function(b,c,a){var g=b("@marcom/ac-headjs");
var d=b("@marcom/ac-useragent");var f=(function(){return{initialize:function(){g.addTests({ie:function(){return(d.browser.ie)
},edge:function(){return(d.browser.edge)}});g.htmlClass();return this}}}());c.exports=f.initialize()
},{"@marcom/ac-headjs":19,"@marcom/ac-useragent":72}]},{},[76]);